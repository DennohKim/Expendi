...
// GET /api/subscriptions/[id]/transactions - Get subscription transaction history
export async function GET(
  ...
  try {
    ...
    return NextResponse.json(
      { 
        success: false, 
        error: error instanceof Error ? error.message : 'Failed to get subscription transactions' 
      },
      { status: 500 }
    );
  }
