...
export default function WalletDropdown() {
  ...
  return (
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DropdownMenuContent 
        className="absolute mt-[17px] flex w-[280px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark lg:left-0 lg:right-auto sm:right-0 sm:left-auto left-0"
        side="bottom"
        align="start"
        sideOffset={8}
      >
